...
function () {
  ...
  /*#__PURE__*/
  _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee3(userExists) {
    var fci, fc, userDetails;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            fci = $(".flip-card-inner");
            fc = $(".flip-card"); // if(!g_email)

            g_email = $("#email").val();
            fci.removeClass('link-sent');
            _context3.next = 14;
            return fc.fadeIn(1000);

          case 14:
            console.log(g_email);
            _context3.next = 17;
            return axios.post("/pwd-link?registered=".concat(userExists), {
              email: g_email
            });
          ...
          case 17:
            ...
            if (userDetails.status === 200) {
              ...
              setTimeout(function () {
                ok.addClass('zoomOut'); // ok.addClass('d-none');
                //fc.fadeOut(1000);
                // $("#progressive").fadeOut()
              }, 3000);
            }
  ...
  return function sendPwdLink(_x2) {
...
function validate() {
  ...
  if (email.length < 1) {
    if (getPasswordLinkPressed) {
      $result.text('Email is empty :(');
      $result.css({
        color: 'red'
      });
    }
...
$(".start-process").on('click', "#getDecision",
/*#__PURE__*/
_asyncToGenerator(
/*#__PURE__*/
_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee2() {
    ...
    while (1) {
      switch (_context3.prev = _context3.next) {
        ...
        case 2:
          ...
          return _context3.abrupt("return", $result.text("email is not valid"));

        case 6:
          Object(_api_calls__WEBPACK_IMPORTED_MODULE_1__["validateEmailDB"])().then(function (res) {
            shakeLoginUser(res);
    ...
    while (1) {
      switch (_context4.prev = _context4.next) {
        ...
        case 3:
          ...
          return _context4.abrupt("return", console.log("not Valid . stop."));
