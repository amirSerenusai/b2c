...
{{--                    <a href="index.html" class="standard-logo" data-dark-logo="images/logo-dark.png"><img src="images/logo.png" alt="Canvas Logo"></a>--}}
                    <a href="index.html" class="standard-logo" data-dark-logo="assets/images/logo/serenus logo _left.svg"><img src="{{asset('assets/images/logo/logo.svg')}}" alt="Canvas Logo"></a>
{{--                    <a href="index.html" class="retina-logo" data-dark-logo="images/logo-dark@2x.png"><img src="images/logo@2x.png" alt="Canvas Logo"></a>--}}
                    <a href="index.html" class="retina-logo" data-dark-logo="assets/images/serenus logo _left.svg"><img src="{{asset('assets/images/logo/logo.png')}}" alt="Canvas Logo"></a>
                </div><!-- #logo end -->
...
{{--    <section id="slider" class="slider-element slider-parallax full-screen dark" style="background: url(images/landing/static.jpg) center center no-repeat; background-size: cover">--}}
        <section id="slider" class="slider-element slider-parallax full-screen dark" style="
          background: url(images/main-milky-way-gray.jpg) center center no-repeat; background-size: cover">

        <div class="slider-parallax-inner">

            <div class="container-fluid vertical-middle clearfix">

                <div class="heading-block title-center nobottomborder" style="text-shadow: 10px 1px 30px rgb(41, 171, 253);">
{{--                    <h1>Starter's Guide to create Landing Pages</h1>--}}
{{--                    {{  <span>Building a Landing Page was never so Easy &amp; Interactive</span>--}}
                    <h1> Enhance your knowledge, before a risky medical procedure</h1>
                    <br><br>
                    <b>

                        <p style="font-size: 20px"><i class="fa fa-check"></i> Become updated with evidence based medical practices.</p>
                        <p style="font-size: 20px"><i class="fa fa-check"></i> Be informed of alternative conservative measures.</p>
                        <p style="font-size: 20px"><i class="fa fa-check"></i> Developed by world renowned specialists.</p>
                    </b>
